...
public class AddEmployeePage {
	...
	// Page object repo for search emp
	...
	// page operations for delete emp
	...
	//Page operation methods
		 ...
		 * @param mName
		 * @return 
		 * this method will search emp and return fname and lname
		 */
		 ...
		 * this method will edit the fname , mname and lname and save it
		 */
		...
		/**
		 * @return 
		 * this method will delete searched emp and return no records found text
		 */
